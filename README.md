...
- [ ] matching engine (limit/market cancel/modify): implement the full engine logic, including limit orders, market orders, cancels, and modifications
- [ ] implement custom data structures (linked list, hash map): required for eventual optimization, but practice is done here
